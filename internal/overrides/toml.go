...
// findTOML locates a key inside a table, tracking [table] headers as it scans.
...
// insertTOML puts a new assignment at the end of its table, creating the table
// header when the file does not have one yet.
