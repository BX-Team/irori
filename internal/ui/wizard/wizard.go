...
// Run drives the wizard and returns the config it produced, or nil if the user
// backed out.
...
// filterable marks the steps whose lists can grow long enough to need a filter.
