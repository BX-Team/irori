...
// SpaceBetween pads between left and right so the result is exactly width
// cells wide, truncating the left side first when it does not fit.
...
// Bar renders a full-width rounded bar, the frame of the top and bottom rows.
