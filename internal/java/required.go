...
// versionParts pulls the leading numeric components out of a version string.
// It stops at the first non-numeric component so a snapshot like "26w03a"
// reduces to [26] and sorts alongside the release it leads up to.
...
// compareVersions orders two component lists, treating a missing component as
// zero so "1.21" and "1.21.0" compare equal.
...
// RequirementNote explains where a required major came from, for the settings
// form. An empty string means nothing is required.
